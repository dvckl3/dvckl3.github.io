...
Như vậy $\displaystyle \left(\text{pk} ,\text{sk}\right) =( d,dG)$
...
trong đó $\displaystyle \beta _{i}$ không được cho biết và $\displaystyle |\beta _{i} |< B$ với $\displaystyle B< p$ nào đó.
